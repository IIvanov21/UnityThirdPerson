...
public class PlayerDodgingState : PlayerBaseState
{
    ...
    public PlayerDodgingState(PlayerStateMachine stateMachine,Vector2 dodgingDirectionInput) : base(stateMachine)
    {
    ...
    {
        remainingDodgeTime = stateMachine.DodgeDurtaion;
        ...
        stateMachine.Animator.CrossFadeInFixedTime(DodgeBlendTreeHash, CrossFixedTime);
    ...
    public override void Tick(float deltaTime)
    {
        ...
        movement += stateMachine.transform.right * dodgingDirectionInput.x * stateMachine.DodgeLength / stateMachine.DodgeDurtaion;
        movement += stateMachine.transform.forward * dodgingDirectionInput.y * stateMachine.DodgeLength / stateMachine.DodgeDurtaion;
